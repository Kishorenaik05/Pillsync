...
with open('test_payload_py.txt', 'w', encoding='utf-8') as f:
    if row:
        ...
        # Exact frontend payload with empty strings
        med_data = {
            "name": "Test Nulls",
            "form": "",
            "strength": "",
        ...
        f.write(f"MED: {res_med.status_code} - {res_med.text}\n")
        ...
        if res_med.status_code == 201:
            ...
            f.write(f"SCHED: {res_sch.status_code} - {res_sch.text}\n")
    else:
        f.write("No user\n")
